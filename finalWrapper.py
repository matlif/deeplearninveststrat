...
class MyLSTM:
    ...
    def creatDirectory(self):
        ...
        export_dir = './Results2/{0}'.format('LSTM-' + datetime.strftime(datetime.now(), '%Y%m%d%H%M') +'-Paras-' + nameList + '/')
        return export_dir
...
class MyWrapper:
    ...
    def run(self):
        ...
        print('..............Running Model.............')
        a = MyLSTM(self.X_train_total, self.X_test_total, self.Y_train_total, self.Y_test_total, self.parameters)
