...
class algo2:
    ...
    def __init__(self, initial_prices, initial_indicators, initial_volume, stockNumber, tickerList):
        ...
        self.top_indices = np.argsort(-self.indicator_arr)[:self.n]
        ...
        self.shares[self.top_indices] = (self.avail_capital / self.n / self.price_arr[self.top_indices]).astype(int)
        self.avail_capital -= np.dot(self.price_arr, self.shares)

        self.tradingHistory = {'Buy':{self.months:self.tickers[self.top_indices]}, 'Sell':{}}
        self.holdingStock = {self.months:self.tickers[self.top_indices]}
    ...
    def update_portfolio(self):
        ...
        self.holdingStock[self.months] = self.new_top_indices
        self.top_indices = self.new_top_indices
