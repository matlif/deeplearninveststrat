...
class MyGRU:
    ...
    def creatDirectory(self):
        ...
        export_dir = './Results2/{0}'.format('GRU-' + datetime.strftime(datetime.now(), '%Y%m%d%H%M') +'-Paras-' + nameList + '/')
        return export_dir
...
class MyWrapper2:
    ...
    def run(self):
        ...
        print('..............Running Model.............')
        a = MyGRU(self.X_train_total, self.X_test_total, self.Y_train_total, self.Y_test_total, self.parameters)
...
if __name__ == '__main__':
    ...
    MyWrapper2 = MyWrapper2(data, parameters)
    parameters, MAE, MSE, pnl, mysharpe = MyWrapper2.run()
